...
function Sites() {
  ...
  return (
    <>
      <h1 className="page-heading marB10">Sites</h1>
      ...
      <div className="sites_ticket_listing">
        ...
        >
          <table className="table table-striped table-hover dataTables-example10">
            ...
            <tbody>
              {data?.sitesData?.data &&
                Object.values(data.sitesData.data).length > 0 &&
                Object.values(data.sitesData.data).map((result) => {
                  return (
                    <>
                      <tr>
                        ...
                        <td className="paddR0 paddL0">
                          <Link className="comment-operations icon" to={`/sites_client_view/${result.id}`}><span class="arrow-right"></span></Link>
                        </td>
                      </tr>
                    </>
                  );
